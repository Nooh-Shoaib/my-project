                                ...
                                <>
                                        ...
                                        <div className="container mx-auto">
                                                {tech[0].cards && tech[0].cards.length > 0 && (
                                                        <div className="max-w-[1425px] mx-auto grid lg:grid-cols-3 grid-cols-2 md:grid-cols-4 lg:px-20 md:px-3 gap-x-12 gap-y-6 py-0 px-1">
                                                ...
                                                {tech[0].testing && tech[0].testing.length > 0 && (
                                                        <div className="l;gmax-w-[1425px] mx-auto grid lg:grid-cols-4 grid-cols-2 md:grid-cols-4 lg:px-20 md:px-5 gap-x-12 gap-y-6 py-0 px-1">
