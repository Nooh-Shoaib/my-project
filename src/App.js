...
function App() {
  return (
    <div>
      <Header />
      {/* <SidebarIcons /> */}
      <h1 className='text-center font-semibold text-2xl'>Lorem ipsum</h1>
      ‫עברית हिन्दी Magyar Indonesia Italiano Latviski Lietuviškai македонски Melayu Norsk Polski Português Româna Pyccкий Српски Slovenčina Slovenščina Español Svenska ไทย Türkçe Українська Tiếng Việt
      Lorem Ipsum
