...
const TestimonialsSection = () => {
        ...
        return (<>
                ...
                <div className="testimonial flex justify-around">
                        <div className=" w-[700px] shadow-2xl rounded-2xl my-12 relative">
                                <div className="testimonial-section" data-aos="zoom-in">
                                        <OwlCarousel
                                                ...
                                                dots
                                                autoplay
                                                navText={['<i class="fa-solid fa-chevron-left absolute top-40 -left-10 text-5xl"></i>', '<i class="fa-solid  text-5xl -right-10 fa-chevron-right absolute top-40"></i>']}
                                                responsive={{
                                                        0: {
                                                                items: 1,
                                                        },
                                        ...
                                        >
                                                {testimonialData.map((testimonial, index) => (
                                                        <div key={index} className="py-6 px-5">
                                                                <img src={testimonial.image} alt="Client" className="max-w-[100px] h-[100px] container mx-auto rounded-full" />
                                                                ...
                                                                <p dangerouslySetInnerHTML={{ __html: testimonial.quote }} className="text-center mt-5" />
                                                        </div>
                                                ))}
                                        </OwlCarousel>
                                </div>
