...
const HowWork = () => {
        return (
                <div className=''>
                        <h1 className='text-center lg:text-4xl text-2xl md:text-4xl lg:mb-2 lg:mt-0 mt-52 font-semibold'>For whom we work?</h1>
                        <div className='flex justify-center space-x-4 py-3'>
                                <hr className='w-12 mt-2' />
...
const EcommerceSolution = () => {
        return (<div className='flex justify-center my-40'>
                <div className="mb-6 text-center">
                        ...
                        />
                        <button className='border-2 border-black lg:px-16 px-7 py-2 lg:my-0 my-3 rounded transition-all font-semibold hover:bg-black hover:text-white'>
                                More On UX Design
                        </button>                </div>
...
export { LatestTechnologies, HowWork, Info, EcommerceSolution };
