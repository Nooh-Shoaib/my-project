                        ...
                        <section className='bg-black '>
                                ...
                                <div className='h-24 flex justify-between items-center'>
                                        ...
                                        <div className='space-x-5'>
                                                ...
                                                <button className=" py-3.5 px-1.5 md:px-4 lg:px-5 rounded-md font-semibold border-2 mx-3 lg:mx-0 border-white bg-white text-black my-3 lg:text-lg text-base">
